...
- (void)viewDidLoad
{
    ...
    [self.menulists addObject:@{kTitleKey:@"TextView",
                                ...
                                kVCKey:@"QYTextViewVC"}];
    [self.menulists addObject:@{kTitleKey:@"Web",
                                kSubTitleKey:@"Use of UIWebView",
                                kVCKey:@"QYWebViewVC"}];
    [self.menulists addObject:@{kTitleKey:@"Transition",
                                kSubTitleKey:@"Use of UIWebView",
                                kVCKey:@"QYTransitionVC"}];

    [self.menulists addObject:@{kTitleKey:@"Pickers",
                                kSubTitleKey:@"Use of UIPickersView",
                                kVCKey:@"QYPickerVC"}];
