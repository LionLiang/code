...
- (void)showActionSheet
{
    ...
    MySecondViewController *mySecond = [[MySecondViewController alloc] init];
    [self.navigationController pushViewController:mySecond animated:YES];
