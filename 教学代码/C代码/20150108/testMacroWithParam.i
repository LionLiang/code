# 1 "testMacroWithParam.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 170 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "testMacroWithParam.c" 2
...
{
    int result = (10)<0 ?-(10):(10);
    int result2 = (-10)<0 ?-(-10):(-10);


    int ret = 100 + 200;
    int ret2 = 100+2*3 + 100 + 200;
    ...
    printf("the max value is %d\n",(600+400)>(300+200)?(600+400):(300+200));
